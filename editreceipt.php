...
if (empty($_SESSION['admin'])) {
  header('location:index.php');
	...
	if (!empty($_POST)) {
		...
		$query = "UPDATE receipt SET cre_date='$pdate',customer_id='$cid',bill_amount='$bill',customer_name='$cname',contact_number='$contact',p_description='$pdes',color_size='$color',address='$address'WHERE receipt_id = '$rid'";
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="cid" value="<?php echo $data['customer_id']?>" class="form-control" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
